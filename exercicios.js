...
RESPOSTA LETRA A) O padrão define um algoritmo dividido em vários passos, onde alguns desses passos são a implementação 
da parte comum, enquanto outros são lacunas a serem preenchidas pelo desenvolvedor. 
...
RESPOSTA LETRA B) Especialista na Informação
...
RESPOSTA LETRA A) Um dos fatores para escolha do criador é o fato da classe geradora conter as informações
necessárias para inicialização das instâncias geradas.
...
RESPOSTA LETRA E) Acoplamento Fraco
...
RESPOSTA LETRA E) Definindo uma classe de persistência genérica